public class Main {
    ...
    public static void main(String[] args) {
        ...
        Subtask subtask_1_3 = new Subtask("Подзадача 1-3", "Описание подзадачи 1-3.", epic1_id);
        int subtask_1_3_id = taskManager.addSubtask(subtask_1_3);
        Epic epic2 = new Epic("Эпик 2", "Описание эпика 2");
        int epic2_id = taskManager.addEpic(epic1);
        ...
        Task task = taskManager.getTaskById(task1_id);
        task = taskManager.getTaskById(task2_id);
        task = taskManager.getEpicById(epic1_id);
        task = taskManager.getEpicById(epic2_id);
        task = taskManager.getSubtaskById(subtask_1_1_id);
        task = taskManager.getSubtaskById(subtask_1_2_id);
        task = taskManager.getSubtaskById(subtask_1_3_id);
        printHistory(taskManager);
        task = taskManager.getTaskById(task2_id);
        task = taskManager.getEpicById(epic2_id);
        task = taskManager.getSubtaskById(subtask_1_2_id);
        ...
        taskManager.removeTaskById(task1_id);
        printHistory(taskManager);
        System.out.println();
